    ...
    if (self) {
        ...
        _noteColors = [[NSDictionary alloc] initWithObjectsAndKeys:
                   ...
                   [UIColor colorWithRed:228.0/255.0 green:200.0/255.0 blue:138.0/255.0 alpha:1.0], @"sandyYellow",
                    nil];
        _colorsArray = [NSArray arrayWithObjects:
                        [UIColor colorWithRed:220.0/255.0 green:215.0/255.0 blue:144.0/255.0 alpha:1.0],
                        [UIColor colorWithRed:169.0/255.0 green:216.0/255.0 blue:139.0/255.0 alpha:1.0], 
                        [UIColor colorWithRed:158.0/255.0 green:197.0/255.0 blue:231.0/255.0 alpha:1.0], 
                        [UIColor colorWithRed:208.0/255.0 green:151.0/255.0 blue:225.0/255.0 alpha:1.0], 
                        [UIColor colorWithRed:244.0/255.0 green:167.0/255.0 blue:153.0/255.0 alpha:1.0], 
                        [UIColor colorWithRed:228.0/255.0 green:200.0/255.0 blue:138.0/255.0 alpha:1.0],
                        nil];
    }
   return self;
}
